      ...
      <v-col v-if="cartStore.total" cols="12" md="4">
        <v-card class="py-5 px-4">
          ...
          <v-card-text>
            ...
            <div class="py-3">
              <v-text-field label="Enter Voucher Code" variant="outlined" density="compact" clearable @change="handleInputChange($event)"></v-text-field>
            </div>
