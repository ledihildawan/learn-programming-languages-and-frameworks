...
# Variable assignment it is a named symbol that holds a value.
# Varibles are always assigned with the varibale name on the left and the value on the right of the equals sign.
